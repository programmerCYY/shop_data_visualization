...
<template>
  <div class="com-container">
    ...
    <img :src="changeType" class="button" @click="handleType"/>
  </div>
</template>
...
export default {
  ...
  computed: {
    // changeType(){
    //   return "/static/img/" + getThemeValue(this.theme).typeSrc;
    // },
    catName() {
      if (!this.allData) {
        return "";
  ...
  methods: {
    ...
    handleType() {
      if (this.currentType === "sunburst") {
        this.currentType = "pie";
        this.changeType = "/static/img/sunburst.png"
      } else {
        this.currentType = "sunburst";
        this.changeType = "/static/img/pie.png"
      }
      this.initChart();
      this.$socket.send({
        action: "getData",
